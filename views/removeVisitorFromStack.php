...
<head>
    ...
    <link rel="stylesheet" href=<?="http://vsit.bhent.org/vsit/" . "public/assets/css/removeVisitorFromStack.css"?>>
</head>
...
<body>
                ...
                <div id="operations">
                    ...
                    <?php if ( $_SESSION['role'] == 'manager' ) { ?>
                        ...
                        <div class="operations-box">
                            ...
                            <span id="generate-report"><a href=<?="http://vsit.bhent.org/vsit/" . "dashboard/makeReportView"?>>Générer le rapport</a></span>
                        </div>
    ...
    <script src=<?="http://vsit.bhent.org/vsit/" . "public/assets/js/removeVisitorFromStack.js"?>></script>
