...
<head>
    ...
    <link rel="stylesheet" href=<?="http://vsit.bhent.org/" . "public/assets/css/login.css"?>>
</head>
...
<body>
        ...
        <div id="login-form">
            ...
            <div id="form-container">
                <form autocomplete="off" autofocus method="post" id="form">
                    ...
                    <div class="fields">
                        Pas encore enregistré? <a href=<?="http://vsit.bhent.org/" . "login/registration"?>>Créer un compte</a>
                    </div>
                </form>
            </div>
        </div>
        <div id="login-icon">
            <img src=<?="http://vsit.bhent.org/" . "public/assets/icons/login-icon.svg"?>>
            <div id="desc">
    ...
    <script src=<?="http://vsit.bhent.org/" . "public/assets/js/login.js"?>></script>
